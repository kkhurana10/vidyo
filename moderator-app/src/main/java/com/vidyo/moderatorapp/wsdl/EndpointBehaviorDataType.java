 ...
 * 
 * <p>Java class for EndpointBehaviorDataType complex type</p>.
 * 
 ...
 *         <element name="logoutOnUserHangup" type="{http://www.w3.org/2001/XMLSchema}int"/>
...
public class EndpointBehaviorDataType {
    ...
    @XmlElement(defaultValue = "0")
    protected int logoutOnUserHangup;
    ...
    /**
     * Gets the value of the logoutOnUserHangup property.
     * 
     */
    public int getLogoutOnUserHangup() {
        return logoutOnUserHangup;
    }

    /**
     * Sets the value of the logoutOnUserHangup property.
     * 
     */
    public void setLogoutOnUserHangup(int value) {
        this.logoutOnUserHangup = value;
    }
